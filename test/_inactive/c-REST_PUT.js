...
describe("Contacts app rest enpoints unit test", function() {
  ...
  it("should PUT all users", function(done) {
    server
      .get('/REST/users/')
  ...
  it("should PUT user info", function(done) {
    server
      .get('/REST/users/' + uid + '/')
      .expect("Content-type", /json/)
      .expect(200)
  ...
  it("should PUT all contacts for a user", function(done) {
    server
  ...
  it("should PUT information from a user contact", function(done) {
    server
  ...
  it("should PUT all AUTH USER data", function(done) {
    server
      .get('/REST/user/')
      .expect(404)
      .end(function(err, res) {
  ...
  it("should PUT all AUTH USER contacts", function(done) {
    server
  ...
  it("should PUT an AUTH USER contact information", function(done) {
    server
