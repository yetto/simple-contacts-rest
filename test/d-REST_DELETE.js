...
describe("Contacts app rest enpoints unit test", function() {
  ...
  it("should DELETE all contacts for a user", function(done) {
    server
  ...
  it("should DELETE information from a user contact", function(done) {
    server
  ...
  it("should DELETE all AUTH USER data", function(done) {
    server
      .get('/REST/user/')
      .expect(404)
      .end(function(err, res) {
  ...
  it("should DELETE all AUTH USER contacts", function(done) {
    server
  ...
  it("should DELETE an AUTH USER contact information", function(done) {
    server
